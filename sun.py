...
l = {'EenaduTg': 1, 'Eenadu_Ap': 2, 'Eenadu_Ghyd': 3}
...
if (ch == 1):
    state = 'Eenadu_Ghyd'
    try:
        get_paper(dt[0], dt[1], dt[2], l[state], 0, state, 'Sunday')
...
if (ch == 3):
    ...
    try:
        ...
        co = 0
        total = 0
        get_paper(dt[0], dt[1], dt[2], 367, 0, f'Eenadu_Sunday {date}', 'Sunday')
